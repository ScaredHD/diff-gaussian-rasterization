...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, num_buckets, color, transmittance, invdepths, radii, geomBuffer, binningBuffer, imgBuffer, sampleBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, transmittance

    @staticmethod
    def backward(ctx, grad_out_color, _, grad_out_depth, grad_out_transmittance):
